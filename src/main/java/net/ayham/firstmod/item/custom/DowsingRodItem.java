package net.ayham.firstmod.item.custom;
...
public class DowsingRodItem extends Item {
    ...
    private boolean isValuableBlock(Block block) {
        return block == Blocks.DEEPSLATE_IRON_ORE || block == Blocks.COPPER_ORE
                || block == Blocks.DIAMOND_ORE || block == Blocks.IRON_ORE
                || block == Blocks.DEEPSLATE_DIAMOND_ORE || block == Blocks.DEEPSLATE_COPPER_ORE
